...
enum class ResponseCode(
    ...
    USER_EMAIL_DUPLICATED(HttpStatus.CONFLICT, "중복된 이메일이 이미 존재합니다."),
    ...
    FOLLOW_DUPLICATED(HttpStatus.BAD_REQUEST, "이미 상대방을 팔로잉하고 있습니다."),
    FOLLOW_BAD_REQUEST(HttpStatus.BAD_REQUEST, "스스로를 팔로우할 수 없습니다."),
